...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if(!$errors["username"] && !$errors["password"] && !$errors["confirmpassword"] && !$errors["regpass"])
	{
		...
		$query = $pdo->prepare("INSERT INTO users (username, password, email, jointime, lastonline, regip, status) VALUES (:username, :password, 'placeholder', UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), :ip, 'I\'m new to Vapor!')");
...
pageBuilder::$pageConfig["title"] = "Register";
	...
	<div class="col-sm-8 divider-right align-self-center">
		<form method="post">
			<div class="form-group row">
			    <label for="username" style="color:black;" class="col-4 col-form-label">Username: </label>
			    <div class="col-6">
			...
			<div class="form-group row">
			    <label for="password" style="color:black;" class="col-4 col-form-label">Password: </label>
			    <div class="col-6">
			...
			<div class="form-group row">
			    <label for="confirmpassword" style="color:black;" class="col-4 col-form-label">Confirm Password: </label>
			    <div class="col-6">
			...
			<div class="form-group row">
			    <label for="confirmpassword" style="color:black;" class="col-4 col-form-label">Registration Passcode (Join The <a href="https://discord.gg/n4A9wzW7bh">Discord</a> to get it): </label>
			    <div class="col-6">
