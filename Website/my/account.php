...
<h2 style="color:black;" class="font-weight-normal">My Account</h2>
<div class="row">
  <div class="col-md-6 p-0 divider-right">
    <div class="p-3 pr-4">
      <h3 style="color:black;" class="pb-4 font-weight-normal">Settings</h3>
      <div class="form-group row">
        <label style="color:black;" for="blurb" class="col-sm-3 col-form-label">Blurb</label>
        <div class="col-sm-9">
  ...
  <div class="col-md-6 p-0">
    <div class="py-3">
      <h3 style="color:black;" class="pb-4 pl-4 font-weight-normal">Security</h3>
      <ul class="nav nav-tabs pl-4" id="securityTabs" role="tablist">
        <li class="nav-item">
          <a style="color:black;" class="nav-link active" id="twofa-tab" data-toggle="tab" href="#twofa" role="tab" aria-controls="twofa" aria-selected="true">Two-Factor Authentication</a>
        </li>
        <li class="nav-item">
          <a style="color:black;" class="nav-link" id="changepwd-tab" data-toggle="tab" href="#changepwd" role="tab" aria-controls="changepwd" aria-selected="false">Change Password</a>
        </li>
        <li class="nav-item">
          <a style="color:black;" class="nav-link" id="sessions-tab" data-toggle="tab" href="#sessions" role="tab" aria-controls="sessions" aria-selected="false">Sessions</a>
        </li>
      </ul>
      <div class="tab-content pt-4 pl-4" id="securityTabsContent">
        <div style="color:black;" class="tab-pane active" id="twofa" role="tabpanel" aria-labelledby="twofa-tab">
          coming soon
        </div>
        <div class="tab-pane" id="changepwd" role="tabpanel" aria-labelledby="changepwd-tab">
          <div class="form-group row">
            <label style="color:black;" for="currentpwd" class="col-sm-4 col-form-label">Current Password</label>
            <div class="col-sm-8">
              <input type="password" class="form-control" id="currentpwd">
            </div>
          </div>
          <div class="form-group row">
            <label style="color:black;" for="newpwd" class="col-sm-4 col-form-label">New Password</label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label style="color:black;" for="newpwd" class="col-sm-4 col-form-label">Confirm New Password</label>
            <div class="col-sm-8">
        ...
        <div class="tab-pane" id="sessions" role="tabpanel" aria-labelledby="sessions-tab">
          <div class="row">
            ...
            <div class="col-sm-6 mb-4 <?=$session->sessionKey == $_COOKIE['vapor_session']?'current-session':'session'?>">
              <div class="card<?=$session->sessionKey == $_COOKIE['vapor_session']?' bg-primary text-white':''?>">
                <div class="card-body text-center">
                  ...
                  <?php if($session->sessionKey == $_COOKIE['vapor_session']){ ?>This is your current session<?php } else { ?>
