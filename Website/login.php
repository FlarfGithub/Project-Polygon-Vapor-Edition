...
<div class="row pt-4">
	<div class="col-sm-6 p-0 px-5 pb-5 divider-right">
		<form method="post">
			<div class="form-group row">
				<label for="username" style="color:black;" class="col-3 col-form-label">Username: </label>
				<div class="col-9">
			...
			<div class="form-group row">
				<label for="password" style="color:black;" class="col-3 col-form-label">Password: </label>
				<div class="col-9">
	...
	<div class="col-sm-6">
		<div class="card">
		  ...
		  <div class="card-body">
		    <h3 style="color:black;" class="card-title text-center">Sign Up</h3>
		    <p style="color:black;" class="card-text text-center">more text goes here</p>
