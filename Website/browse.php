...
$query->execute();
pageBuilder::$pageConfig["title"] = "Browse";
...
<form method="post">
	...
	<table class="bg-light">
	  <thead>
	    <tr>
	      <th scope="col" style="color:black; width:5%">Avatar</th>
	      <th scope="col" style="color:black; width:20%">Name</th>
	      <th scope="col" style="color:black; width:55%">Blurb</th>
	      <th scope="col" style="color:black; width:20%">Location / Last Seen</th>
	    </tr>
	  </thead>
	  <tbody class="">
	    ...
	    <tr>
	      ...
	      <td style="color:black;"><?=htmlspecialchars($row->blurb)?></td>
	      <td class="text-danger mb-0"><?=($onlineStatus["online"]?'Online':'Offline').': '.$onlineStatus["text"]?></td>
	    </tr>
		<?php } ?>
	  </tbody>
	</table>
