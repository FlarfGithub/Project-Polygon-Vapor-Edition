...
<div class="row">
	...
	<div class="col-md-6 p-0 divider-right">
		<div class="px-4 pt-2 pb-4">
			<h1 style="color:black;" class="font-weight-normal"><?=$pronouns["your"]?> Profile</h1>
			...
			<div style="color:black;" class="text-center"><?=$userinfo->blurb;?></div>
			<?php if(!$selfProfile) { ?>
		...
		<div class="py-4">
			<h1 style="color:black;" class="font-weight-normal pl-4">Badges</h1>
			<br>
			<ul class="nav nav-tabs pl-4" id="badgestabs" role="tablist">
		        <li class="nav-item">
		          <a class="nav-link active" style="color:black;" id="vapor-badges-tab" data-toggle="tab" href="#vapor-badges" role="tab" aria-controls="vapor-badges" aria-selected="true"><?=SITE_CONFIG["site"]["name"]?> Badges</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link" style="color:black;" id="user-badges-tab" data-toggle="tab" href="#user-badges" role="tab" aria-controls="user-badges" aria-selected="false">Player Badges</a>
		        </li>
		    </ul>
		    <div class="tab-content pt-4 pl-4" id="badgestabsContent">
		        <div class="tab-pane active" id="vapor-badges" role="tabpanel" aria-labelledby="vapor-badges-tab">
		        	<div class="row vapor-badges-pane">
			  		</div>
		        </div>
		        <div class="tab-pane" id="user-badges" role="tabpanel" aria-labelledby="user-badges-tab">
		        	<div style="color:black;" class="row user-badges-pane">
			  		</div>
		        </div>
		    </div>
		</div>
	...
	<div class="col-md-6 p-0">
		<div class="px-4 py-1">
			<h1 style="color:black;" class="font-weight-normal">Active Places</h1>
			<br>
			<p style="color:black;"><?=$pronouns["you"]?> have any active places.</p>
		</div>
		<div class="divider-top"></div>
		<div class="py-3">
			<!--h1>Friends</h1-->
			<div class="row pl-4">
				<div style="color:black;" class="col-9"><h1 class="font-weight-normal">Friends</h1></div>
			...
			<div class="tab-content pt-4 pl-4" id="friendsTabsContent">
			  <div class="tab-pane active" id="friends" role="tabpanel" aria-labelledby="friends-tab" data-uid="<?=$userid?>" data-limit="6" data-selfpage="<?=$selfProfile?'true':'false'?>">
			  	...
			  	<div style="color:black;" class="friends-tab-content row">
			  	</div>
			  </div>
		...
		<div class="divider-top"></div>
		<div class="pl-4 py-3">
			<h1 style="color:black;" class="font-weight-normal">Favorites</h1>
			<br>
			<ul class="nav nav-tabs" id="favoritetabs" role="tablist">
			  <li class="nav-item">
			    <a class="favorite-tab nav-link" style="color:black;" href="#" data-toggle="tab" role="tab" aria-controls="Faces" aria-selected="false">Faces</a>
			  </li>
			  <li class="nav-item">
			    <a class="favorite-tab nav-link" style="color:black;" href="#" data-toggle="tab" role="tab" aria-controls="Gears" aria-selected="false">Gears</a>
			  </li>
			  <li class="nav-item">
			    <a class="favorite-tab nav-link" style="color:black;" href="#" data-toggle="tab" role="tab" aria-controls="Decals" aria-selected="false">Decals</a>
			  </li>
			  <li class="nav-item">
			    <a class="favorite-tab nav-link" style="color:black;" href="#" data-toggle="tab" role="tab" aria-controls="Models" aria-selected="false">Models</a>
			  </li>
			  <li class="nav-item">
			    <a class="favorite-tab nav-link" style="color:black;" href="#" data-toggle="tab" role="tab" aria-controls="Heads" aria-selected="false">Heads</a>
			  </li>
			  <li class="nav-item">
			    <a class="favorite-tab nav-link" style="color:black;" href="#" data-toggle="tab" role="tab" aria-controls="T-Shirts" aria-selected="false">T-Shirts</a>
			  </li>
			  <li class="nav-item">
			    <a class="favorite-tab nav-link active" style="color:black;" href="#" data-toggle="tab" role="tab" aria-controls="Places" aria-selected="true">Places</a>
			  </li>
			  <li class="nav-item">
			    <a class="favorite-tab nav-link" style="color:black;" href="#" data-toggle="tab" role="tab" aria-controls="Hats" aria-selected="false">Hats</a>
			  </li>
			  <li class="nav-item">
			    <a class="favorite-tab nav-link" style="color:black;" href="#" data-toggle="tab" role="tab" aria-controls="Shirts" aria-selected="false">Shirts</a>
			  </li>
			  <li class="nav-item">
			    <a class="favorite-tab nav-link" style="color:black;" href="#" data-toggle="tab" role="tab" aria-controls="Pants" aria-selected="false">Pants</a>
			  </li>
			</ul>
			<div class="tab-content p-2" id="favoritetabsContent">
			  <div style="color:black;" class="tab-pane fade show active favorite-pane" role="tabpanel">
			  </div>
			</div>
		</div>
	</div>
...
<script>
	...
	{ 
		...
		loadBadges(<?=$userid?>, <?=$selfProfile?'true':'false'?>, "vapor-badges", 1);
