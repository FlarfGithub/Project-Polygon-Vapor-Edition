...
if(!in_array($_GET['type'], ["user-badges", "vapor-badges"])){ api::respond(400, false, "Invalid Request - invalid badge type"); }
...
{  
	...
	$responsemsg .= $_GET['type'] == "user-badges" ? " player-made badges" : " vapor badges";
}
else
{
	$responsemsg = $badges;
